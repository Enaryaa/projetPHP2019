...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="dropdown">
      <button class="btn btn-outline-success my-2 my-sm-0 dropdown-toggle" type="button" id="menuUser" data-toggle="dropdown" aria-hasgroup="true" aria-expanded="false"><?php echo $user['pseudo']; ?></button>
