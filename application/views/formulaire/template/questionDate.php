<div id="qRep">
<input type="hidden" name="question[<?php echo $cpt; ?>][type_rep]" value="date">
<div class="form-group">
	<label for="exampleFormControlTextarea1">Question à champ date</label>
	<input name="question[<?php echo $cpt; ?>][text_quest]" class="form-control" id="question" rows="1" />
</div>
<div class="form-group" >
    <label for="exampleFormControlTextarea1">Aide</label>
    <input name="question[<?php echo $cpt; ?>][text_aide]" class="form-control" id="aide" rows="1" />
  </div>
